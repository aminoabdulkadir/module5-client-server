...
Server response: Hello, this is a test file!
...
Client Output:
Enter filename to request: missing.txt
Server response: Error: File not found.
...
Client Output:
Enter filename to request: long.txt
Server response: This is a long line. This is a long line. ... (truncated at 255 characters)
